									...
									<div class="main-menu__update-box-left">
										<div class="main-menu__update-icon-box">
											<div class="main-menu__update-icon icon-svg">
												<?php \Elementor\Icons_Manager::render_icon($settings['news_ticker_icon'], ['aria-hidden' => 'true'], 'span'); ?>
											</div>
										...
										<?php foreach ($settings['topbar_infos'] as $index => $item) : ?>
											<li>
												<div class="icon icon-svg">
													<?php \Elementor\Icons_Manager::render_icon($item['topbar_icon'], ['aria-hidden' => 'true'], 'i'); ?>
												</div>
												<div class="text">
